    ...
    opts = {
        ...
        dashboard = {
            ...
            preset = {
                ...
                keys = {
                    ...
                    { icon = "", key = "r", desc = "Recent Files", action = ":Telescope oldfiles" },
                    {
                        ...
                        desc = "Sessions",
                        action = function()
                            require("mlamkadm.core.session_manager").sessions_with_readme()
                        end,
                    },
                    ...
                    },
                    {
                        ...
                        desc = "TUI Commands",
                        action = function()
                            require("mlamkadm.core.terminal").show_tui_registry()
                        end,
                    },
                    {
                        icon = "󱌣",
                        ...
                        desc = "btop",
                        action = function()
                            require("mlamkadm.core.ui").open_page("btop")
                        end,
                    },
                    {
                        icon = "󰺢",
                        ...
                        desc = "lazydocker",
                        action = function()
                            require("mlamkadm.core.ui").open_page("lazydocker")
                        end,
                    },
                    {
                        icon = "󰺢",
            ...
            sections = {
                ...
                {
                    section = "terminal",
                    cmd = vim.fn.expand("~/repos/active/aart/aart") .. " --raw --center " .. vim.fn.expand(
                        "~/.config/aart/dashboard-art.aa"
                    ),
                    height = 26,
                    padding = 1,
                    ttl = 0,
        ...
        vim.api.nvim_create_autocmd("User", {
            ...
            callback = function()
                vim.defer_fn(function()
                    vim.notify(
                        "Press 'b' for btop, 'd' for lazydocker, 'h' to change theme",
                        vim.log.levels.INFO,
                        { timeout = 2000 }
                    )
                end, 1000)
