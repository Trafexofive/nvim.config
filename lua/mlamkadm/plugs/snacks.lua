    ...
    dashboard = {
      ...
      preset = {
        ...
        keys = {
          ...
          { icon = "󱌣",  key = "n", desc = "New Session",      action = function() require("mlamkadm.core.session_manager").create_new_session() end },
          { icon = "󰦉",  key = "w", desc = "Temp Workspace",   action = function() require("mlamkadm.core.session_manager").create_temp_session() end },
          { icon = "",   key = "D", desc = "Delete Session",   action = function() require("mlamkadm.core.session_manager").delete_session() end },
          ...
          { icon = "󰺢",  key = "h", desc = "Change Theme",     action = function() require("mlamkadm.core.theme").select_theme() end },
