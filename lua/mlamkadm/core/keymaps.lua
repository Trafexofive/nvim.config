...
map(
    "n",
    "<leader>vm",
    '<cmd>lua require("mlamkadm.utils.vim_motions_cmd").show_motions_cmd()<cr>',
    { desc = "Open Vim Motions Registry" }
)
...
map("n", "<leader>fs", function()
    require("mlamkadm.core.rss").telescope_search()
end, { desc = "Search RSS Feeds" })
