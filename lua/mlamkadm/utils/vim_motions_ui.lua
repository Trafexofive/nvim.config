...
function M.show_motions_popup()
    ...
    vim.api.nvim_buf_set_keymap(
        ...
        "n",
        "<CR>",
        '<Cmd>lua require("mlamkadm.utils.vim_motions_ui").execute_motion()<CR>',
    ...
    vim.api.nvim_buf_set_keymap(
        ...
        "n",
        "q",
        '<Cmd>lua require("mlamkadm.utils.vim_motions_ui").close_popup()<CR>',
        { silent = true, noremap = true }
    )
    vim.api.nvim_buf_set_keymap(
        buf,
        "n",
        "r",
        '<Cmd>lua require("mlamkadm.utils.vim_motions_ui").reorder_motion()<CR>',
        { silent = true, noremap = true }
    )
    vim.api.nvim_buf_set_keymap(
        buf,
        "n",
        "<Up>",
        '<Cmd>lua require("mlamkadm.utils.vim_motions_ui").move_motion_up()<CR>',
        { silent = true, noremap = true }
    )
    vim.api.nvim_buf_set_keymap(
        buf,
        "n",
        "<Down>",
        '<Cmd>lua require("mlamkadm.utils.vim_motions_ui").move_motion_down()<CR>',
        { silent = true, noremap = true }
    )
    vim.api.nvim_buf_set_keymap(
        buf,
        "n",
        "n",
        '<Cmd>lua require("mlamkadm.utils.vim_motions_ui").add_new_motion()<CR>',
        { silent = true, noremap = true }
    )
    vim.api.nvim_buf_set_keymap(
        buf,
