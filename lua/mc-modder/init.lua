...
local function get_config()
    return require("mc-modder.config")
end
local function get_scaffold()
    return require("mc-modder.scaffold")
end
local function get_gradle()
    return require("mc-modder.gradle")
end
local function get_maven()
    return require("mc-modder.maven")
end
local function get_lsp()
    return require("mc-modder.lsp")
end
    ...
    if mappings.scaffold then
        if mappings.scaffold.create_mod then
            vim.keymap.set("n", mappings.scaffold.create_mod, function()
                local mod_type = vim.fn.input(
                    "Enter mod type (fabric/forge/quilt) [fabric]: ",
                    "fabric",
                    "customlist,v:lua.require'mc-modder'.get_mod_types"
                )
